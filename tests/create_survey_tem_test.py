...
def test_create_survey_tem():
    ...
    # name = "TestCurrents"
    # n_data = 12
    workspace = Workspace(r"C:\Users\dominiquef\Desktop\TEM.geoh5")

    obj = workspace.get_entity("MA1_MW_ShC_Bz_20191127_rot330_zone_e rx")[0]
    print(obj.waveform)
    # assert isinstance(
    #     obj.waveform, np.ndarray
    # ), "Waveform must be of type numpy.ndarray"
