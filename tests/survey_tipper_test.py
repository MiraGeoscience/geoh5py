...
def test_create_survey_tipper(tmp_path):
    ...
    # Create a workspace
    receivers.copy(Workspace().save(tmp_path / r"test_Tipper_copy.geoh5"))
    ...
    # Create a workspace
    with Workspace().save(tmp_path / r"test_Tipper_copy2.geoh5") as new_workspace:
